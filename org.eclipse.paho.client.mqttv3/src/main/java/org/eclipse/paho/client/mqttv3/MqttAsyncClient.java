...
public class MqttAsyncClient implements IMqttAsyncClient { // DestinationProvider {
	 ...
	 * off persistence, use the {@link #MqttAsyncClient(String, String, String, String, MqttClientPersistence)}
	 * constructor.
	 *
	 ...
	 */
	public MqttAsyncClient(String serverURI, String clientId, String developerId, String appId) throws MqttException {
		this(serverURI, clientId, developerId, appId, new MqttDefaultFilePersistence());
	}
	
	public MqttAsyncClient(String serverURI, String clientId, String developerId, String appId, MqttClientPersistence persistence) throws MqttException {
		this(serverURI, clientId, developerId, appId, persistence, new TimerPingSender());
	}
	 ...
	 * @throws MqttException if any other problem was encountered
	 */
	public MqttAsyncClient(String serverURI, String clientId, String developerId, String appId, MqttClientPersistence persistence, MqttPingSender pingSender) throws MqttException {
        ...
        this.appId = appId;
        this.topicPrefix = '/'+developerId+'/'+appId+'/';
...
//				}
	...
	public IMqttToken subscribe(String[] topicFilters, int[] qos, Object userContext, IMqttActionListener callback) throws MqttException {
		...
		for (int i = 0; i < topicFilters.length; ++i) {
		    topicFilters[i] = topicPrefix + topicFilters[i];
	...
	public IMqttDeliveryToken publish(String topic, MqttMessage message, Object userContext, IMqttActionListener callback) throws MqttException,
        ...
        // replace topic to cluster topic architecture
