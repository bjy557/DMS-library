...
public class MqttClient implements IMqttClient { //), DestinationProvider {
    ...
    protected String developerId = null;   // MQTT Service's developer id
    protected String appId = null;         // MQTT Service's application id
     ...
     * @param developerId a developer identifier that is generated from service dashboard
     * @param appId an application identifier that is generated from service dashboard
	 ...
	 */
	public MqttClient(String serverURI, String clientId, String developerId, String appId) throws MqttException {
	 ...
	 * @throws MqttException if any other problem was encountered
	 */
	public MqttClient(String serverURI, String clientId, String developerId, String appId, MqttClientPersistence persistence) throws MqttException {
		aClient = new MqttAsyncClient(serverURI, clientId, developerId, appId, persistence);
	}
